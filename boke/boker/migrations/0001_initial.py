# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-09-23 09:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='u0', to='boker.Users')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='notice',
            name='n_auth',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='u2', to='boker.Users'),
        ),
        migrations.AddField(
            model_name='essay',
            name='e_auth',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='u1', to='boker.Users'),
        ),
        migrations.AddField(
            model_name='essay',
            name='e_part',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ess', to='boker.Part'),
        ),
        migrations.AddField(
            model_name='comment',
            name='c_auth',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='u3', to='boker.Users'),
        ),
        migrations.AddField(
            model_name='comment',
            name='c_com',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='c1', to='boker.Essay'),
        ),
    ]
